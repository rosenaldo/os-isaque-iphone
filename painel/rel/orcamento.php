...
<body>
	...
	<div id="header">
			...
			<table style="width: 100%; border: 0px solid #ccc;">
				<tr>
					...
					<td style="width: 40%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>N° <?php echo $id ?></big></b><br>CNPJ: <?php echo $cnpj_sistema ?><br>CONTATO: <?php echo $telefone_sistema ?><br> <?php echo mb_strtoupper($data_hoje) ?>
					</td> 			
				</tr>
			</table>
		</div>
		...
		<p style="font-size: 8px; text-align: left;">
			A empresa se responsabilizará pela entrega deste aparelho somente mediante a apresentação deste comprovante.
			Após 90 dias a partir da data de entrega, a empresa poderá dispor do equipamento, a fim de cobrir as despesas,
			conforme os artigos 1.275, 1.592, 3.995 do Código Civil Brasileiro, sem prejuízo do disposto no artigo 1.278.
		</p>
