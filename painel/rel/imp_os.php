 ...
 <tr>
	...
	<tfoot>
		...
		<tr style="margin-top:2px; text-align:center">
			<td colspan="3"><small><b>Equipamento:</b> <?php echo $equipamento ?></small></td>			
		</tr>
		<?php } ?>
		...
		<tr style="margin-top:2px; text-align:center">
			<td colspan="3"><small><b>Situação:</b> <?php echo $situacao ?></small></td>			
		</tr>
		<?php } ?>
		...
		<tr style="margin-top:2px; text-align:center">
			<td colspan="3"><small><b>Laudo:</b> <?php echo $laudo ?></small></td>			
		</tr>
		<?php } ?>
		...
		<tr style="margin-top:2px; text-align:center">
			<td colspan="3"><small><b>Acessórios:</b> <?php echo $acessorios ?></small></td>			
		</tr>
		<?php } ?>
		...
		<tr style="margin-top:2px; text-align:center">
			<td colspan="3"><small><b>Condições:</b> <?php echo $condicoes ?></small></td>			
		</tr>
		<?php } ?>
		...
		<tr >
		<th colspan="3"><small>Data <?php echo $dataF ?> / Previsão de Entrega <b><?php echo $data_entregaF ?></b></small>
		</th>
	</tr>
...
<p style="font-size: 10px; margin-left: 12;">
			A empresa se responsabilizará pela entrega deste aparelho somente mediante </p> 
<p style="font-size: 10px; margin-left: 8;">a apresentação deste comprovante. Após 90 dias a partir da data de entrega,</p>  
<p style="font-size: 10px; margin-left: 8;">a empresa poderá dispor do equipamento, a fim de cobrir as despesas,</p> 
<p style="font-size: 10px; margin-left: 8;">conforme os artigos 1.275, 1.592, 3.995 do Código Civil Brasileiro,</p>
<p style="font-size: 10px; margin-left: 8;"> sem prejuízo do disposto no artigo 1.278.</p> 
		


<br><br>
<div style="margin-left: 80px;">__________________________</div>
<div style="margin-left: 140px;"><small>Assinatura do Cliente</small></div>
